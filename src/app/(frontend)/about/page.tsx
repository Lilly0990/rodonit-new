        ...
        <div className="max-w-3xl mx-auto px-4 py-12">
          <div className="space-y-4 text-gray-700">
            ...
            <p>
              ...
              агрономії. Щороку ми закладаємо понад 100 дослідів на всій території України (з них 50–60 —
              науково-виробничі), щоб і надалі забезпечувати клієнтів якісними рішеннями для аграрного виробництва.
            </p>
          </div>
