          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Компанія «Родоніт Агро» заснована у 2019 році. Сьогодні наш основний напрямок — аграрний
                сектор, а продуктовий портфель налічує шість препаратів для захисту рослин та живлення.
              </p>
              <p className="text-gray-600 mb-6">
                Це усвідомлений вибір: замість широкого асортименту ми зосередились на продуктах, які
                закривають ключові потреби аграріїв — від контролю хвороб до профілактики дефіциту
